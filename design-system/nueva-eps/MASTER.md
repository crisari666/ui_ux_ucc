...
> **LOGIC:** When building a specific page, first check `design-system/nueva-eps/pages/[page-name].md`.
> If that file exists, its rules **override** this Master file.
> If not, strictly follow the rules below.
>
> **Information architecture:** See `INFORMATION-ARCHITECTURE.md` in this folder for sitemap, flows, and navigation rules.

---

**Project:** Nueva EPS
**Generated:** 2026-05-18 09:58:20
